...
?>
	...
	<footer id="colophon" class="site-footer" role="contentinfo">
		...
		<div class="site-info">
			...
			<span class="sep"> | </span>
			<?php printf( __( 'Theme: %1$s by %2$s.', 'Willingness' ), '<a href="'.esc_url( 'http://enwil.com/willingness' ).'" rel="designer">Willingness</a>', '<a href="'.esc_url('http://enwil.com/').'" rel="designer">Manish Suwal</a>' ); ?>
